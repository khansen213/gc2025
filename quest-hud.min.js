...
const DIALOG_SCRIPTS = {
  'sec-intro': [
    { emoji:'🧙‍♂️', voicePrefs:['Google UK English Male','Daniel','Alex'],
      text:'Behold, mortals. I am the Alien Wizard. From the void I come to claim the scrolls of your magic.',
      onLine: _mentionsScrollsHook },
    { emoji:'🧚‍♀️', voicePrefs:['Google US English','Samantha','Victoria'],
      text:'Your greed ends here, sorcerer. These scrolls are the lifeblood of our kingdom. Traveler, speak your alias and true name — stand with us.',
      onLine: _mentionsScrollsHook },
  ...
  'sec-overview': [
    ...
    { emoji:'🐉', voicePrefs:['Google UK English Male','Daniel','Alex'],
      ...
      onLine: _mentionsScrollsHook },
    { emoji:'🧚‍♀️', voicePrefs:['Google US English','Samantha','Victoria'],
      text:'Traveler, see the dragon’s HP — the number of scrolls across the kingdom. Guard it well.',
  ...
  'sec-submit': [
    { emoji:'🧚‍♀️', voicePrefs:['Google US English','Samantha','Victoria'],
      text:'Traveler, sign with your initial. Seal your legend. Then print your proof and deliver it.' },
    { emoji:'🧙‍♂️', voicePrefs:['Google UK English Male','Daniel','Alex'],
...
function typeLine(full){
  ...
  const tick=()=>{
    ...
    if(dlg.charIndex>=full.length){
      dlg.typing=false; speak(full); return;
    }
